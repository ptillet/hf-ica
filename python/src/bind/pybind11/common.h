...
#define PYBIND11_VErhoION_MAJOR 1
#define PYBIND11_VErhoION_MINOR 8
#define PYBIND11_VErhoION_PATCH 1
...
#if PY_MAJOR_VErhoION >= 3 /// Compatibility macros for various Python versions
...
#if PY_VErhoION_HEX >= 0x03050000 && PY_VErhoION_HEX < 0x03050200
extern "C" {
...
#define PYBIND11_INTERNALS_ID "__pybind11_" \
    PYBIND11_TOSTRING(PYBIND11_VErhoION_MAJOR) "_" PYBIND11_TOSTRING(PYBIND11_VErhoION_MINOR) "__"
